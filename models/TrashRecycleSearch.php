...
/**
 * TrashRecycleSearch represents the model behind the search form about `app\models\TrashRecycle`.
 */
class TrashRecycleSearch extends TrashRecycle
{
    /**
     * @inheritdoc
     */
